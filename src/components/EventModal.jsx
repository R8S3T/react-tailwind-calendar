                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between">
                            <button
                                ...
                                className="mt-3 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-button-color text-base font-medium text-white hover:bg-button-color-hover focus:outline-none sm:mt-0 sm:ml-2 sm:w-auto sm:text-sm">Add Event</button>
